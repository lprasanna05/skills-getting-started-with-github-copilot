document.addEventListener("DOMContentLoaded", () => {
  ...
  function setSignupLoading(isLoading) {
    ...
    if (!signupButton.dataset.defaultLabel) {
      signupButton.dataset.defaultLabel = signupButton.textContent;
    }

    signupButton.disabled = isLoading;
    signupButton.textContent = isLoading ? "Signing up..." : signupButton.dataset.defaultLabel;
  }
